/**
 * @file lexer_errors.cc
 * @license This file is licensed under the GNU GENERAL PUBLIC LICENSE Version 3, 29 June 2007. You may obtain a copy of this license at https://www.gnu.org/licenses/gpl-3.0.en.html.
 * @author Tushar Chaurasia (Dark-CodeX)
 */

#include "./lexer_errors.hh"
...
namespace horizon
{
    ...
    {
        std::pair<horizon_deps::string, std::size_t> lexer_errors::getline(const horizon_deps::string &str, const std::size_t &start, const std::size_t &end__, const horizon_deps::string &color)
        {
